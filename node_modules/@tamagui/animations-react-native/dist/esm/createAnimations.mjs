  ...
  return {
    ...
    useAnimations: ({
      ...
      const isDisabled = isWeb && componentState.unmounted === !0,
        ...
        isThereNoNativeStyleKeys = React.useMemo(() => isWeb ? !0 : Object.keys(style).some(key => animateOnly.length ? !animatedStyleKey[key] && animateOnly.indexOf(key) === -1 : !animatedStyleKey[key]), args),
        res = React.useMemo(() => {
          const runners = [],
            completions = [],
            nonAnimatedStyle = {};
