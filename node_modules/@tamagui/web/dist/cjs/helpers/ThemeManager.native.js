...
var uid = 0, ThemeManager = /* @__PURE__ */ function() {
  ...
  return _create_class(ThemeManager2, [
    ...
    },
    {
      key: "getParents",
      value: function() {
        for (var parents = [], current = this; current; )
          parents.push(current), current = current.parentManager;
        return parents;
      }
    },
    {
...
function getState(props, manager) {
  ...
  for (var base = baseName.split(import_constants2.THEME_NAME_SEPARATOR), max = base.length, min = props.componentName && !nextName ? max : (
    ...
    if (process.env.NODE_ENV !== "production" && typeof props.debug == "string" && import_constants.isClient && console.info(` \u{1F537} [${manager == null ? void 0 : manager.id}] getState`, {
      props,
      found,
      potentials,
      baseManager,
