...
const DIALOG_NAME = "Dialog", [createDialogContext, createDialogScope] = createContextScope(DIALOG_NAME), [DialogProvider, useDialogContext] = createDialogContext(DIALOG_NAME), TRIGGER_NAME = "DialogTrigger", DialogTriggerFrame = styled(View, {
  ...
  const { __scopeDialog, children, space, spaceDirection, separator } = props, themeName = useThemeName(), context = useDialogContext(PORTAL_NAME, props.__scopeDialog);
  ...
  })), /* @__PURE__ */ jsx(AdaptPortalContents, { children: /* @__PURE__ */ jsx(DialogProvider, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ jsx(Theme, { name: themeName, children: childrenSpaced }) }) });
}, DialogPortal = (props) => {
  ...
  if (context.modal) {
    const contents = /* @__PURE__ */ jsx(AnimatePresence, { onExitComplete: handleExitComplete, children: isShowing || isAdapted ? children : null });
    ...
    return isWeb ? /* @__PURE__ */ jsx(Portal, { zIndex: props.zIndex ?? 1e5, children: /* @__PURE__ */ jsx(PassthroughTheme, { children: framedContents }) }) : framedContents;
  }
  return children;
